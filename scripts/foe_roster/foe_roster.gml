...
function foe_roster() {
	static _ros = [
		...
		{ name : "thos",    shape : { hp : 5, mp : 2, atk : 6, mag : 1, def : 3, mdef : 2, spd : 9, hit : 8 }, crit : 9,  cmulti : 1.6, cnt : 5,  erode : 1,   magic : false, skill : "",        gear : 0,  col : rgb(190, 160, 110), lands : ["desert", "hills"] },
