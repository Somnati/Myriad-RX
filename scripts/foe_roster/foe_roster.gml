...
function foe_roster() {
	static _ros = [
		...
		{ name : "slime",     shape : { hp : 8, mp : 6, atk : 3, mag : 3, def : 6, mdef : 6, spd : 2, hit : 4 }, crit : 5,  cmulti : 1.5, cnt : 4,  erode : .25, magic : false, skill : "reform",  gear : 0,  col : c_seagreen,          lands : ["sewer", "dungeon", "marsh", "mine", "ruin"] },
		...
		{ name : "vesper",       shape : { hp : 4, mp : 2, atk : 5, mag : 2, def : 3, mdef : 3, spd : 9, hit : 8 }, crit : 8,  cmulti : 1.5, cnt : 3,  erode : 1,   magic : false, skill : "",        gear : 0,  col : rgb(90, 80, 110),   lands : ["sewer", "crypt", "dungeon", "mine"] },
