/// @description galaxy_world_biome(planet) -> the expedition biome index a galaxy planet lands as (exped_biomes); a gas world is the cloud family (8)
...
function galaxy_world_biome(_pl) {
	if (_pl.kind == "gas") return 8;   // (the cloud family - a giant lands now: cloud cities to come; his call 2026-09-17)
