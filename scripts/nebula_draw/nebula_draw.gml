...
function nebula_draw(_nb, _x, _y, _r, _a) {
	static _u = undefined;
	if (is_undefined(_u)) _u = { seed : shader_get_uniform(sh_nebula, "u_seed"), col : shader_get_uniform(sh_nebula, "u_col"), col2 : shader_get_uniform(sh_nebula, "u_col2"), kind : shader_get_uniform(sh_nebula, "u_kind") };
	if (_r < 1 || _a <= 0) return;
	...
	shader_set_uniform_f(_u.kind, _nb[$ "kind"] ?? 0);
