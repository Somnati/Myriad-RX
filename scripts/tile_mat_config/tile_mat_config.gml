...
function tile_mat_config() {
	static _c = [
		...
		{ tier : 5,  key : "checker", kind : 14 },
		{ tier : 6,  key : "plaid",   kind : 17 },
		{ tier : 7,  key : "lattice", kind : 7  },
		{ tier : 8,  key : "liquid",  kind : 2  },
		{ tier : 9,  key : "ripple",  kind : 8  },
		{ tier : 10, key : "pulse",   kind : 11 },
		{ tier : 11, key : "shimmer", kind : 19 },
		{ tier : 12, key : "marble",  kind : 18 },
		{ tier : 13, key : "hole",    kind : 3  },
		{ tier : 14, key : "ember",   kind : 9  },
		{ tier : 15, key : "rain",    kind : 16 },
		{ tier : 16, key : "spiral",  kind : 15 },
		{ tier : 17, key : "orbit",   kind : 10 },
		{ tier : 18, key : "aurora",  kind : 13 },
		{ tier : 19, key : "static",  kind : 12 },
		{ tier : 20, key : "stars",   kind : 4  },
	];
	return _c;
}
