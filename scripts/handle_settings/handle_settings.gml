...
function handle_settings(_method) {
	...
	g.planet_fine = handle("planet_fine_cell",g.planet_fine); // the world at one room pixel a cell (q301; the key renamed q302 and q308 so the saved default does not hold)
