...
function stk_hook() {
	...
	return { spark : _s.spark, life : _s.life, rate : stk_spark_rate(_s), cinders : _s.cinders, spent : _s.spent, turns : _s.turns, levels : _lv, caps : [stk_cap(_s, 0), stk_cap(_s, 1), stk_cap(_s, 2)] };
}
