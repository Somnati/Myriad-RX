...
function ability_score(_sp, _a) {
	...
	switch (_ln) {
		...
		case "work": _w = .15; break;
		case "work_tap": _w = .08; break;
		case "work_fab": _w = .08; break;
		case "work_merge": _w = .08; break;
		case "work_aura": _w = .3; break;
		case "home_alone": _w = .08; break;
		case "nap": _w = .05; break;
		case "rest_nap": _w = .04; break;
		case "rest_wake": _w = .04; break;
		case "notes": _w = .04; break;
		case "sell": _w = .1; break;
		case "scav": _w = .15; break;
		case "pick": _w = .08; break;
		case "rooms": _w = .15; break;
		case "quest": _w = .15; break;
		case "aura_atk": _w = 1.1; break;
		case "aura_def": _w = 1.1; break;
		case "aura_hit": _w = .8; break;
		case "aura_luck": _w = 6; break;
		case "aura_heal": _w = .3; break;
		case "aura_xp": _w = .5; break;
		case "aura_potion": _w = .2; break;
		case "fire_pow": case "water_pow": case "nature_pow": _w = _phys ? .15 : .3; break;
		case "thorns": _w = .5; break;
		case "hurt_atk": _w = _phys ? 1.2 : .6; break;
		case "hurt_def": _w = 1; break;
		case "duel": _w = .3; break;
		case "pack": _w = .9; break;
		case "lone": _w = .15; break;
		case "last": _w = .3; break;
		case "execute": _w = _phys ? .8 : .3; break;
		case "immune_stagger": _w = 4; break;
		case "nograze": _w = 5; break;
	}
	var _s = _v * _w;
	// THE FLAW'S ANSWER (2026-09-17): an ability on its own flaw's lane, the good way, counts half again - a coward rates brawn
	var _fl = sprite_flaw(_sp);
	if (is_struct(_fl) && _fl.cfg.lane == _ln && _v > 0) _s *= 1.4;
