/// @description exped_unpack_v1(s) - THE OLD POSITIONAL FORMAT (before the keyed one, 2026-09-16): a save written by an earlier build reads through here, untouched
