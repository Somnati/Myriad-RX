...
function exped_quest_gen(_d, _salt = 0, _ri = 0, _easy = false) {
	...
	region_papers_all(_d, _rg);   // (the folk's names, warmed BEFORE the seed - see there; 2026-09-16)
	...
	exped_quest_finish(_q, _rg, _ri, _easy);   // (the tail: hours, reward, difficulty, text - shared with the personal cards, 2026-09-16)
	rng_release(_old);
	return _q;
}
