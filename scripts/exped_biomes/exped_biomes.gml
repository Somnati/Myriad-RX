...
function exped_biomes() {
	static _b = [
		{ name : "stone",  hint : "materials likely",
		  ...
		  loot  : { mats : 50, sprite : 5, offer : 10, credits : 20, charm : 5, chart : 10 } },
		{ name : "living", hint : "sprites likely",
		  ...
		  loot  : { mats : 25, sprite : 35, offer : 10, credits : 20, charm : 5, chart : 5 } },
		{ name : "ruined", hint : "offers and charms",
		  ...
		  loot  : { mats : 10, sprite : 5, offer : 40, credits : 15, charm : 20, chart : 10 } },
		{ name : "ice",    hint : "charts likely",
		  ...
		  loot  : { mats : 35, sprite : 5, offer : 5, credits : 20, charm : 10, chart : 25 } },
	];
	return _b;
}
