...
/// the same curve the multiplier on the price (upgrade_cost) and on the
/// tier ceiling. One table, so a rarity cannot mean one thing to the
/// value and another to the cost.
///   common 1x  uncommon 1.6  rare 2.5  epic 3.8  legendary 5.6
///   elite 8.2  ultimate 12
function upgrade_rarity_mult(_r) {
	var _t = [1, 1.6, 2.5, 3.8, 5.6, 8.2, 12];
