...
if (in_room(rm_gameload) && (!instance_exists(syst_handle_save) || syst_handle_save.boot_phase >= 3)) goto_room(rm_titlescreen);   // (the boot's spinner first: the galaxy, then the load)
